...
//booking;
if (isset($_POST['submittedAdd']) && isset($_POST['startTime']) && isset($_POST['endTime']) && isset($_POST['facility']) && isset($_POST['totalmoney'])){
    //get POST
    $userID = $_POST['user'];
...
//block
elseif (isset($_POST['submittedBlock']) && isset($_POST['startDate']) && isset($_POST['endDate']) && isset($_POST['facility'])){
    ...
    $_POST['msg']="add block successfully";
}
//trainer
elseif(isset($_POST['submittedTrainer'])&&isset($_POST['facility'])&&isset($_POST['startDate'])&&isset($_POST['endDate'])&&isset($_POST['whichDay'])&&isset($_POST['startTime'])&&isset($_POST['endTime'])){
    $userID = $_POST['user'];
    ...
    $_POST['msg']="add course successfully";
}
